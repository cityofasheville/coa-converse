  ...
  <div>
    <div className="row">
      <div className="col-sm-12">
        <h1>Conversations with {props.employee.name}</h1>
        <span style={{ fontSize: '25px', marginTop: '10px' }} className="pull-right">Current Supervisor: {props.employee.review_by || '--'}</span>
      </div>
    </div>
    <ReviewsTable reviews={getCurrentReview(props.employee.reviews)} current/>
    <ReviewsTable reviews={getClosedReviews(props.employee.reviews)} />
  </div>
);
